...
public class CreaGraph {
    ...
    /**
     * Se connecte à la bdd et récupère les données nécessaires dans un dataset
     * (format utilisé pour créer les graphiques).
     *
     ...
     * @return les données récupérées dans un objet DefaultPieDataset propre à
